export const createAppbar = ({ cartEl }) => {
  ...
  result.innerHTML = `
    <nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900">
      <div class="container flex items-center justify-between mx-auto">
        ...
        🛍️<span class="ml-2 self-center text-xl font-semibold whitespace-nowrap dark:text-white">Shop-Cart</span>
        </a>
        <div id="nav-menu" class="flex ml-auto items-center">
  ...
  result.querySelector("#nav-menu").append(cartEl);
